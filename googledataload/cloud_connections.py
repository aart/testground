...
class TestModuleFunctions(unittest.TestCase):
    ...
    def test_create_azure_directory(self, storage_key: str):
        try:
...
def initialize_azure_account(storage_account_name: str,
                             storage_account_key: str) -> azure.storage.filedatalake.DataLakeServiceClient:
    try:
